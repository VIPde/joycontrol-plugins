...
class DistributeRaid_3day(JoycontrolPlugin):
    ...
    async def distribute_raid_3day(self):
        count = 0
        i = 0
        while True:
            # Start the game
    ...
    async def run(self):
        logger.info('Distribute_AnyDate Raid Plugin loaded!')
        await self.distribute_raid_anydate()
